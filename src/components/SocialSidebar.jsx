...
export default function SocialSidebar() {
  ...
  return (
    <div className="hidden sm:flex fixed left-0 top-1/2 z-50 -translate-y-1/2 flex-col gap-1 py-2">
      {items.map((item) => {
        ...
        return (
          <a
            ...
            style={{
              width: active ? '130px' : '36px',
              height: '36px',
              borderRadius: '0 20px 20px 0',
              background: active ? item.color : '#3385AA',
              backdropFilter: 'blur(4px)',
              boxShadow: active ? `0 4px 14px ${item.color}55` : '0 2px 6px rgba(0,0,0,0.2)',
          ...
          >
            ...
            <span
              className="whitespace-nowrap pr-3 text-xs font-bold text-white"
              style={{
                opacity: active ? 1 : 0,
