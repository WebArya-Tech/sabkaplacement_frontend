...
/* --- DATA ------------------------------------------------- */
const trendingRoles = [
  { role: 'Full Stack Developer',  salary: '?8ï¿½22 LPA',  growth: '+34%', demand: 'Very High', color: '#317FA4',  img: 'https://images.pexels.com/photos/1181671/pexels-photo-1181671.jpeg?auto=compress&w=600&h=360&fit=crop' },
  { role: 'Data Scientist',        salary: '?10ï¿½28 LPA', growth: '+41%', demand: 'Very High', color: '#0f766e',  img: 'https://images.pexels.com/photos/8386440/pexels-photo-8386440.jpeg?auto=compress&w=600&h=360&fit=crop' },
  { role: 'Product Manager',       salary: '?14ï¿½35 LPA', growth: '+28%', demand: 'High',      color: '#7c3aed',  img: 'https://images.pexels.com/photos/3183150/pexels-photo-3183150.jpeg?auto=compress&w=600&h=360&fit=crop' },
  { role: 'DevOps Engineer',       salary: '?9ï¿½24 LPA',  growth: '+38%', demand: 'Very High', color: '#b45309',  img: 'https://images.pexels.com/photos/1181677/pexels-photo-1181677.jpeg?auto=compress&w=600&h=360&fit=crop' },
  { role: 'UI/UX Designer',        salary: '?6ï¿½18 LPA',  growth: '+25%', demand: 'High',      color: '#be185d',  img: 'https://images.pexels.com/photos/326503/pexels-photo-326503.jpeg?auto=compress&w=600&h=360&fit=crop' },
  { role: 'Cloud Architect',       salary: '?16ï¿½40 LPA', growth: '+52%', demand: 'Critical',  color: '#0369a1',  img: 'https://images.pexels.com/photos/1181467/pexels-photo-1181467.jpeg?auto=compress&w=600&h=360&fit=crop' },
]

const salaryGuide = [
  { level: 'Fresher (0ï¿½1 yr)',     range: '?3ï¿½6 LPA',   tip: 'Focus on building a strong portfolio and certifications.' },
  { level: 'Junior (1ï¿½3 yrs)',     range: '?5ï¿½10 LPA',  tip: 'Aim for a 25ï¿½30% hike when switching. Negotiate with data.' },
  { level: 'Mid-Level (3ï¿½6 yrs)', range: '?9ï¿½18 LPA',  tip: 'Specialise in a skill ï¿½ it can double your market value.' },
  { level: 'Senior (6ï¿½10 yrs)',   range: '?16ï¿½28 LPA', tip: 'Leadership roles open faster when you mentor others.' },
  { level: 'Lead / Architect',    range: '?24ï¿½45 LPA', tip: 'System design and team management are worth extra ?5ï¿½8 LPA.' },
  { level: 'Director / VP',       range: '?40ï¿½80 LPA', tip: 'Network actively. Most senior roles are filled via referrals.' },
]
...
const careerTips = [
  ...
  },
  {
    ...
    desc: 'Only 37% of candidates negotiate. Those who do earn ?1ï¿½3 LPA more on average. Always counter-offer ï¿½ the worst they say is no.',
    tag: 'Salary',
  },
  {
    icon: ['M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253'],
    color: '#be185d', title: 'Certifications = Fast Hike',
    desc: 'AWS, GCP, PMP, or CFA certifications can add ?2ï¿½6 LPA to your package. Online certifications from Coursera/Google are recruiter-verified.',
    tag: 'Upskilling',
  },
  {
    icon: ['M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z'],
    color: '#b45309', title: 'Switch Strategically',
    desc: 'The ideal switch window is 18ï¿½24 months. Too early looks unstable. Too late means you left money on the table.',
    tag: 'Job Change',
  },
  {
        ...
        <div className="ci-hero-inner" style={{ maxWidth:1100, margin:'0 auto', padding:'28px 24px 48px', display:'flex', alignItems:'center', gap:52, flexWrap:'wrap', position:'relative', width:'100%' }}>
          ...
          <div className="ci-hero-left" style={{ flex:'1 1 360px' }}>
            ...
            <p style={{ fontSize:'1.1rem', color:'#64748b', maxWidth:480, lineHeight:1.8, marginBottom:0 }}>
              Real salary data, trending roles, in-demand skills, and expert career strategies ï¿½ everything you need to make smarter career moves in 2026.
            </p>
          </div>
              ...
              >
                ...
                {openTip===i ? (
                  ...
                  <p style={{ fontSize:'0.82rem', color:'#64748b', margin:0, lineHeight:1.6 }}>
                    {t.desc.slice(0,65)}ï¿½ <span style={{ color:t.color, fontWeight:700 }}>Read more</span>
                  </p>
                )}
              </div>
            ))}
