      ...
      <div className="max-w-6xl mx-auto px-3 sm:px-4 lg:px-8 py-3 sm:py-6">
        <div className="flex flex-col lg:flex-row gap-3 sm:gap-6">
          ...
          <div className="flex-1 min-w-0 w-full">
            ...
            {/* Pagination */}
            <div className="flex flex-wrap items-center justify-center gap-1 mb-6 sm:mb-8">
            ...
            {/* Popular Section */}
            <div className="bg-white rounded-lg sm:rounded-xl border border-gray-200 p-3 sm:p-6 mb-3 sm:mb-4">
