...
function Pagination({ currentPage, onPageChange }) {
  ...
  return (
    <div className="flex items-center justify-center gap-1 mt-4 sm:mt-6 mb-2 flex-wrap">
      <span className="text-xs sm:text-sm text-gray-500 mr-2 sm:mr-3">Page {currentPage} of {TOTAL_PAGES}</span>
      <button
      ...
      <div className="flex gap-6 border-b border-gray-200 mb-4">
        {tabs.map((t) => (
          <button
            ...
            className={`pb-2.5 text-[13.5px] font-medium transition-colors border-b-2 -mb-px ${
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-2.5">
        {current.data.map((item, i) => (
          <div key={i} className="flex items-start gap-2">
            ...
            <span className="text-[13px] text-blue-600 hover:underline cursor-pointer">{item}</span>
          </div>
        ))}
      </div>
    </div>
    ...
    <div className="min-h-screen bg-[#f3f5f7] font-sans">
      ...
      <div className="bg-white border-b border-gray-100 pt-[70px] md:pt-[80px]">
        <div className="max-w-[1200px] mx-auto px-3 sm:px-4 lg:px-8 pt-3 sm:pt-5 pb-3">
          <h1 className="text-lg sm:text-[22px] font-bold text-gray-900 mb-3 sm:mb-4">MNCs actively hiring</h1>
          ...
          <div className="relative">
            <button
              ...
              className={`absolute left-0 top-1/2 -translate-y-1/2 z-10 w-7 h-7 sm:w-7 sm:h-7 rounded-full bg-white shadow border border-gray-200 flex items-center justify-center transition-all ${canScrollLeft ? "opacity-100 cursor-pointer hover:shadow-md" : "opacity-25 cursor-not-allowed"}`}
            >
            ...
            <div
              ...
              className="flex gap-2 sm:gap-3 overflow-x-auto px-9 py-1.5"
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-0.5 mt-0.5">
                      <span className="text-[12px] font-medium text-blue-600">{cat.count}</span>
            ...
            <button
              ...
              className={`absolute right-0 top-1/2 -translate-y-1/2 z-10 w-7 h-7 sm:w-7 sm:h-7 rounded-full bg-white shadow border border-gray-200 flex items-center justify-center transition-all ${canScrollRight ? "opacity-100 cursor-pointer hover:shadow-md" : "opacity-25 cursor-not-allowed"}`}
            >
      ...
      <div className="max-w-[1200px] mx-auto px-3 sm:px-4 lg:px-8 py-3 sm:py-5 flex flex-col lg:flex-row gap-3 sm:gap-5 items-start">
        ...
        {/* ── Sidebar Filters ── */}
        <aside className="w-full lg:w-[240px] flex-shrink-0 bg-white rounded-lg sm:rounded-xl border border-gray-200 p-3 sm:p-4 sticky top-4 hidden lg:block">
        ...
        <main className="flex-1 min-w-0 w-full">
          ...
          {/* Breadcrumb */}
          <div className="flex items-center gap-1.5 mt-5 text-[13px] text-gray-500">
